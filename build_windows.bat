...
echo [COMPILE] %COMPILER% %COMPILER_FLAGS% -Fe"wl_sherlock.exe" "../src/wl_sherlock.cpp" /link %LINKER_FLAGS%
%COMPILER% %COMPILER_FLAGS% -Fe"wl_sherlock.exe" "../src/wl_sherlock.cpp" /link %LINKER_FLAGS%
